...
ActiveRecord::Schema.define(version: 20161027083320) do
  ...
  create_table "word_categories", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["category_id"], name: "index_word_categories_on_category_id", using: :btree
    t.index ["word_id"], name: "index_word_categories_on_word_id", using: :btree
  end
